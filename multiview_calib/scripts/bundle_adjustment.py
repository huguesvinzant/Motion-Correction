...
__config__ = {
    ...
    "output_path": "./multiview_calib/examples/pose/output/bundle_adjustment/"
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", "-n", type=str, required=False, default='default',
                        help='name of the image being passed')
