...
AMASS_DIR = 'VIBE/data/amass'
INSTA_DIR = 'VIBE/data/insta_variety'
MPII3D_DIR = 'VIBE/data/mpi_inf_3dhp'
THREEDPW_DIR = 'VIBE/data/3dpw'
PENNACTION_DIR = 'VIBE/data/penn_action'
POSETRACK_DIR = 'VIBE/data/posetrack'
VIBE_DATA_DIR = 'VIBE/data/vibe_data'
